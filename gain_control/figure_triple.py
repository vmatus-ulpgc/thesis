...
plt.close('all')
fig,ax = plt.subplots(1,3,figsize=(4*3,1*3),sharex=False,sharey=False)

ax[0].plot(20*np.log10(global_camera_gains_vector),(avg_rxy))
...
ax[2].plot(20*np.log10(global_camera_gains_vector),(avg_rxy))
